...
defmodule SublistTest do
  ...
  test "unequal at end" do
    assert Sublist.compare([5,4,3,2,1],[4,3,1]) == :unequal
  end
  ...
  test "recurring values superlist" do
    assert Sublist.compare([1,2,3,1,2,1,2,3,2,1], [1,2,1,2,3]) == :superlist
  end
